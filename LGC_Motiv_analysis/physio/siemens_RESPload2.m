function [signal, time, startTrigger] = siemens_RESPload2(fname,varargin)
%function [signal, time, startTrigger] = RESP_load(fname, optname, optval);
%
...
if nargin < 1 || isempty(fname)
  [filename, filepath] = uigetfile('*.resp','Get Respiration File');
