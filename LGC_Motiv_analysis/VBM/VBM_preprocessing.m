...
for iS = 1:NS
    ...
    matlabbatch{jSeg}.spm.spatial.preproc.channel.vols = '<UNDEFINED>';
    ...
    matlabbatch{jShoot}.spm.tools.shoot.warp.images{2}(1) = cfg_dep('Segment: rc2 Images', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','tiss', '()',{2}, '.','rc', '()',{':'}));
