...
nutri_names.fa = {'fat','fa_monoInsaturated','fa_polyInsaturated',...
    ...
    'butanoicA','hexanoicA','octanoicA','decanoicA','dodecanoicA',...
    'tetradecanoicA','pentadecanoicA','hexadecanoicA','heptadecanoicA',...
    'octadecanoicA','eicosanoicA','decanoicA','tetracosanoicA',...
...
for iS = 1:NS
    ...
    nutrition.raw.fa.decanoicA(iS) = FFQ_struct.FFQ_results.F100_mg_portion__PerWeek(sub_idx); % (F100)
    ...
    nutrition.raw.fa.decanoicA(iS) = FFQ_struct.FFQ_results.F220_mg_portion__PerWeek(sub_idx); % (F220)
