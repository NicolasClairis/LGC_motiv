...
switch study_nm
    ...
    case 'study1'
        switch condition
            case {'behavior','fMRI'}
                ...
                all_subs = {'001','002','003','005','008','009','015','017','018',...
                    ...
                    '076','079',...
                    '081','082','087','088','090','093','095','100'}; % '048'
            case {'behavior_noSatRun','fMRI_noSatRun'}
                all_subs = {'001','003','008','009','015','017','018',...
                    '020','022','029',...
                    '035','036','039','040','044','045','046','050',...
                    '054','055',...
                    '056','060','061','064','065','068','069','071','074','075',...
                    '079',...
                    '081','082','087','088','090','093'}; % '048'
            ...
            case 'fMRI_no_move'
                ...
                all_subs = {'001','002','003','005','009','015','017','018',...
                    ...
                    '056','060','061','064','065','068','069','071','074','075',...
                    '076','079',...
                    '081','082','087','088','090','093','095','100'};
        ...
        warning('check 048 and... for movement');
