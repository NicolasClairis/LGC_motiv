...
switch study_nm
    ...
    case 'study1'
        %% all subjects
        all_subs = {'002','003','008','009','017','020','022','029',...
            '036','039','040','044','045','046','047','050','052','054','055',...
            '056','060','061','064','065','071','074','079',...
            '081','082','087','090','093','095','100'};
        all_subs_no_mvmt = {'002','003','009','017','020','022','036',...
            '039','040','045','046','050','052','055','056',...
            '060','061','064','065','074','079',...
            '081','090','093','095','100'};
        all_subs = all_subs_no_mvmt;
        % too much movement for 008, 029 (run 4 physical), 047 (run 3 mostly, physical run),
        % 054 (run2 and run4 mostly, ie physical runs), 071 (run2 and run 4 ie physical runs), 087
        %
        % borderline movement: 022, 040 (run 4), 050 (run4), 052 (run 2),
        % 056 (run 2 + 3), 064 (run 2), 065 (run3), 079 (run 3), 090 (run 3),
        % 093 (run1 + 3), 095 (run 1)
        warning('check 015, 044 and... for movement');
