...
for iGrp = 1:n_grps
    ...
    input_f_input_bin.(grp_nm)  = input_f_input_bin(:, sub_idx_tmp);
...
for iGrp = 1:n_grps
    grp_nm = mSplit_grps{iGrp};
    hdl.(grp_nm) = errorbar(m_input_f_input_bin,...
        m_ROI_f_input_bin,...
        sem_ROI_f_input_bin,...
        'Color',col.(grp_nm));
...
for iGrp = 1:n_grps
    grp_nm = mSplit_grps{iGrp};
    hdl.(grp_nm) = errorbar(m_ROI_f_ROI_bin,...
        m_output_f_ROI_bin,...
...
for iGrp = 1:n_grps
    grp_nm = mSplit_grps{iGrp};
    hdl.(grp_nm) = errorbar(m_output_f_input_bin,...
