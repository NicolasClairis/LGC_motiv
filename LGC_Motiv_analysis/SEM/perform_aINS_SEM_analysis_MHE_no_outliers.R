...
data_for_SEM <- readMat("bloodLac_aINSLac_MRS_aINS_GLM235_EpEm_Ech_42subs_MHE_no_outliers.mat")

# rename variables
blood_Lac = data_for_SEM$mtrx.MHE.no.outliers[,1]
aINS_Lac = data_for_SEM$mtrx.MHE.no.outliers[,2]
aINS_fMRI = data_for_SEM$mtrx.MHE.no.outliers[,3]
MHE = data_for_SEM$mtrx.MHE.no.outliers[,4]
#create data frame
df = data.frame(blood_Lac, aINS_Lac, aINS_fMRI, MHE)
...
MHE ~ aINS_fMRI + aINS_Lac + blood_Lac
'
