...
# data_for_SEM <- readMat("bloodLac_dmPFCLac_MRS_dmPFC_GLM263_EpEm_Ech_56subs_kEp_no_outliers_old.mat")
# current model
data_for_SEM <- readMat("bloodLac_dmPFCLac_MRS_dmPFC_GLM263_EpEm_Ech_56subs_kEp_no_outliers.mat")
