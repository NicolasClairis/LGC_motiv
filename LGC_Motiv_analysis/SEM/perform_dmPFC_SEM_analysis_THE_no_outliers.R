...
# old model
# data_for_SEM <- readMat("bloodLac_dmPFCLac_MRS_dmPFC_GLM235_EpEm_Ech_58subs_THE_no_outliers.mat")
# current model
data_for_SEM <- readMat("bloodLac_dmPFCLac_MRS_dmPFC_GLM263_EpEm_Ech_58subs_THE_no_outliers.mat")

# rename variables
blood_Lac = data_for_SEM$mtrx.THE.no.outliers[,1]
dmPFC_Lac = data_for_SEM$mtrx.THE.no.outliers[,2]
dmPFC_fMRI = data_for_SEM$mtrx.THE.no.outliers[,3]
THE = data_for_SEM$mtrx.THE.no.outliers[,4]
#create data frame
df = data.frame(blood_Lac, dmPFC_Lac, dmPFC_fMRI, THE)

##############################################################################
## test 1: THE full path
...
THE ~ dmPFC_fMRI + dmPFC_Lac + blood_Lac
'
