...
# old model
# data_for_SEM <- readMat("bloodLac_aINSLac_MRS_aINS_GLM235_EpEm_Ech_43subs_PHE_no_outliers.mat")
# current model
data_for_SEM <- readMat("bloodLac_aINSLac_MRS_aINS_GLM263_EpEm_Ech_43subs_PHE_no_outliers.mat")

# rename variables
blood_Lac = data_for_SEM$mtrx.PHE.no.outliers[,1]
aINS_Lac = data_for_SEM$mtrx.PHE.no.outliers[,2]
aINS_fMRI = data_for_SEM$mtrx.PHE.no.outliers[,3]
PHE = data_for_SEM$mtrx.PHE.no.outliers[,4]
#create data frame
df = data.frame(blood_Lac, aINS_Lac, aINS_fMRI, PHE)
...
PHE ~ aINS_fMRI + aINS_Lac + blood_Lac
'
