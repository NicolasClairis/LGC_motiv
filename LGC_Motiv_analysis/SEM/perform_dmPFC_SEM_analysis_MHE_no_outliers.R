...
data_for_SEM <- readMat("bloodLac_dmPFCLac_MRS_dmPFC_GLM235_EpEm_Ech_58subs_MHE_no_outliers.mat")

# rename variables
blood_Lac = data_for_SEM$mtrx.MHE.no.outliers[,1]
dmPFC_Lac = data_for_SEM$mtrx.MHE.no.outliers[,2]
dmPFC_fMRI = data_for_SEM$mtrx.MHE.no.outliers[,3]
MHE = data_for_SEM$mtrx.MHE.no.outliers[,4]
#create data frame
df = data.frame(blood_Lac, dmPFC_Lac, dmPFC_fMRI, MHE)
...
MHE ~ dmPFC_fMRI + dmPFC_Lac + blood_Lac
'
