...
% will take into account the number of scans of the previous sessions in
% order to pool all the sessions into one single big session
%
% INPUTS
...
%% prepare onsets and regressors of interest/session
for iRun = 1:n_runs
        ...
        case 1 % all sessions independent
            for iRun = 1:n_runs
                ...
                switch allCrossesModel
                    ...
                    case 'boxcar'
                        modelAllCrossesdur = allCrossesDur.(run_full_nm);
                end
                ...
                [matlabbatch] = First_level_loadEachCondition_DCM(matlabbatch, sub_idx, iCond,...
                    'fixation cross', allCrossesOnsets.(run_full_nm), modelAllCrossesdur,...
            ...
            for iTask = 1:nTasks
                ...
                switch allCrossesModel
                    case 'stick'
                        modelAllCrossesdur = 0;
                    case 'boxcar'
                        modelAllCrossesdur = allCrossesDur.(task_nm);
                end
                ...
                %% load all
                [matlabbatch] = First_level_loadEachCondition_DCM(matlabbatch, sub_idx, iCond,...
                    'fixation cross', allCrossesOnsets.(task_nm), modelAllCrossesdur,...
                    n_allCrossesMods, allCrosses_modNames, allCrosses_modVals,...
                    orth_vars, onsets_only_GLM);
            end % task loop
        case {3,4,5} % all fixation crosses pooled across sessions
            ...
            switch allCrossesModel
                case 'stick'
                    modelAllCrossesdur = 0;
                case 'boxcar'
                    modelAllCrossesdur = allCrossesDur.allTrials;
            end
            ...
            %% load all
            [matlabbatch] = First_level_loadEachCondition_DCM(matlabbatch, sub_idx, iCond,...
                'fixation cross', allCrossesOnsets.allTrials, modelAllCrossesdur,...
                n_allCrossesMods, allCrosses_modNames, allCrosses_modVals,...
                orth_vars, onsets_only_GLM);
    end % info about how regressors concatenated or not across tasks or sessions
