function[matlabbatch] = First_level_loadRegressors_DCM(matlabbatch, GLMprm, study_nm, sub_nm, sub_idx, iRun, jRun,...
    subBehaviorFolder, currRunBehaviorFileName, task_fullName, computerRoot,...
    n_scansPerRun, TR)
% [matlabbatch] = First_level_loadRegressors_DCM(matlabbatch, GLMprm, study_nm, sub_nm, sub_idx, iRun, jRun,...
