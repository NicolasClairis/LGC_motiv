...
for iSubject = 1:NS
    ...
    switch condition
        case {'fMRI','fMRI_noSatRunSub','fMRI_noSatTaskSub',...
            ...
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM)],'SPM.mat')};
        case 'fMRI_noSatTask'
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM),'_no_satTask'],'SPM.mat')};
        case 'fMRI_noSatRun'
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM),'_no_satRun'],'SPM.mat')};
        case 'fMRI_noMove_bis'
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM),'_noMvmtRun_lenient'],'SPM.mat')};
        case 'fMRI_noMove_ter'
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM),'_noMmvmtRun_stringent'],'SPM.mat')};
        case 'fMRI_noSatTask_noMove_bis'
            matlabbatch{iSubject}.spm.stats.con.spmmat = {fullfile(mainPath,...
                ['GLM',num2str(GLM),'_no_satTask_noMmvmtRun'],'SPM.mat')};
    end
