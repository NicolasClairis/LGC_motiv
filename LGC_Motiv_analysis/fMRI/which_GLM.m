...
switch GLM
    ...
    case 252 % like GLM 248 but adding RT
        % general parameters
        GLMprm.gal.add_drv = 1; % temporal derivative
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 0;
    ...
    case 253 % variant of GLM 235 but orthogonalizing variables in the following order: RT/SV/Ech
        % general parameters
        GLMprm.gal.orth_vars = 1;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 254 % same as GLM 253 but opposite order of orthogonalization
        % general parameters
        GLMprm.gal.orth_vars = 1;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 255 % exactly the same as GLM 235 but allowing to have 2 separate versions
        % one focused on NS = 63 subjects and the other including back
        % subjects 054 and 090 in the analysis to see if results are stable
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 256 % exactly the same as GLM 235 and 255 but allowing to have 3 separate versions
        % one focused on NS = 63 subjects (GLM 235), the other including back
        % subjects 054 and 090 in the analysis (GLM 255) and the last removing subject 054 but keeping 090
        % to see if results are stable (GLM 256)
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 257 % onsets-only GLM to match with GLM 235/255/256
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 258 % onsets-only GLM like GLM 94 but with different masking
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.grey_mask = 3;
        GLMprm.gal.mask_probaThreshold = 5;
    ...
    case 259 % same as GLM 235 and 253
        % but orthogonalizing variables in the following serial order:
        % Ech/SVch/DT
        % general parameters
        GLMprm.gal.orth_vars = 1;
        GLMprm.gal.zPerRun = 1;
    ...
    case 261 % same as GLM 235 but replacing SVch by Rch/Pch
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 262 % same as GLM 261 but using R and P levels
        % general parameters
        GLMprm.gal.orth_vars = 0;
        GLMprm.gal.zPerRun = 1;
        GLMprm.gal.grey_mask = 3;
    ...
    case 266 % main GLM: hE/hSV/RT split between hEch/lEch, like GLM 260 but using corrected model 5
        ...
        for iEpm = 1:length(Epm)
            ...
            GLMprm.model_onset.(Epm_nm).choice = 'stick';
            % low E chosen
            GLMprm.choice.(Epm_nm).RP.lEch.NV_mdl = 'bayesianModel_5';
            GLMprm.choice.(Epm_nm).RP.lEch.NV_varOption = 4;
            GLMprm.choice.(Epm_nm).RP.lEch.E_varOption = 1;
            GLMprm.choice.(Epm_nm).RP.lEch.RT = 1;
            % high E chosen
            GLMprm.choice.(Epm_nm).RP.hEch.NV_mdl = 'bayesianModel_5';
            GLMprm.choice.(Epm_nm).RP.hEch.NV_varOption = 4;
            GLMprm.choice.(Epm_nm).RP.hEch.E_varOption = 1;
            GLMprm.choice.(Epm_nm).RP.hEch.RT = 1;
            % chosen
