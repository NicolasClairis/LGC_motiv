...
% that can be checked (dmPFC/aIns). Subjects are then split with a simple 
% median split according to their levels of metabolites.Then, you can 
% select some specific contrast of interest and look at the difference 
% in BOLD activity between the two groups with a simple t.test.
