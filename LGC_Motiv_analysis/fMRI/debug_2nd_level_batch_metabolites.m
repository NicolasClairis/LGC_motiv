function[] = debug_2nd_level_batch_metabolites(GLM, condition, gender)
% debug_2nd_level_batch_metabolites(GLM, condition, gender)
% script to launch contrasts one by one in order to detect which contrasts
% are problematic and to perform those which are not problematic.
%
% INPUTS
