function[avg_nonDefaultChoice, sem_nonDefaultChoice,...
    avg_conf, sem_conf,...
    avg_RT, sem_RT,...
    avg_Eperformance, sem_Eperformance] = checkChoiceNonDefaultProportion_group_f_BOLD(study_nm, n_bins)
% [avg_nonDefaultChoice, sem_nonDefaultChoice,...
%     avg_conf, sem_conf,...
%     avg_RT, sem_RT,...
%     avg_Eperformance, sem_Eperformance] = checkChoiceNonDefaultProportion_group_f_BOLD(study_nm, n_bins)
%% checkChoiceNonDefaultProportion_group_f_BOLD checks average proportion of choosing 
% the non-default option and the average level of confidence across
% participants depending on the levels of the selected regression estimate.
% 
% INPUTS
...
fMRI_GLM_nm = inputdlg('Which GLM?');
fMRI_GLM = str2double(fMRI_GLM_nm);
...
%% define ROI and regressor you want to test
[con_vec_all,...
    ~, ~, ~,...
    con_names,...
...
short_con_nm = spm_input('Short name for con?',1,'s');

%% peform median split based on the regressor of interest
med_ROI_beta = median(ROI_beta_values, 'omitnan');
low_ROI_beta_subs = ROI_beta_values <= med_ROI_beta;
high_ROI_beta_subs = ROI_beta_values > med_ROI_beta;
...
for iTask = 1:nTaskTypes
    ...
    for iGrp = 1:nGrps
        ...
        switch grp_nm
            case 'low'
                subsToInclude = low_ROI_beta_subs;
            case 'high'
                subsToInclude = high_ROI_beta_subs;
        end
...
legend([bar_hdl.Em_low, bar_hdl.Em_high, bar_hdl.Ep_low, bar_hdl.Ep_high],...
    {['mental l',short_con_nm],['mental h',short_con_nm],...
    ['physical l',short_con_nm],['physical h',short_con_nm],},...
    'Location','NorthWest');
legend('boxoff');
legend_size(pSize);
...
for iMoney = [-(n_R_levels-1):(-1), 1:(n_R_levels - 1)]
    ...
    bar_hdl.Em_low = bar(iMoney-bDist*3/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iMoney-bDist/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iMoney+bDist/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iMoney+bDist*3/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iMoney-bDist*3/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        sem_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney-bDist/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        sem_nonDefaultChoice.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        sem_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist*3/2,...
        avg_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        sem_nonDefaultChoice.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
end
ylim([0 100]);
ylabel('Choice non-default option (%)');
...
for iMoney = [-(n_R_levels-1):(-1), 1:(n_R_levels - 1)]
    ...
    bar_hdl.Em_low = bar(iMoney-bDist*3/2,...
        avg_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iMoney-bDist/2,...
        avg_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iMoney+bDist/2,...
        avg_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iMoney+bDist*3/2,...
        avg_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iMoney-bDist*3/2,...
        avg_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        sem_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney-bDist/2,...
        avg_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        sem_conf.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist/2,...
        avg_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        sem_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist*3/2,...
        avg_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        sem_conf.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
end
xticks([-3:-(1), 1:3]);
xticklabels({'-3','-2','-1','1','2','3'});
...
hold on;
for iE = 1:(n_E_levels - 1)
    bar_hdl.Em_low = bar(iE-bDist*3/2,...
        avg_conf.perElevel.(['Em_',num2str(iE)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iE-bDist/2,...
        avg_conf.perElevel.(['Em_',num2str(iE)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iE+bDist/2,...
        avg_conf.perElevel.(['Ep_',num2str(iE)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iE+bDist*3/2,...
        avg_conf.perElevel.(['Ep_',num2str(iE)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iE-bDist*3/2,...
        avg_conf.perElevel.(['Em_',num2str(iE)]).low,...
        sem_conf.perElevel.(['Em_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE-bDist/2,...
        avg_conf.perElevel.(['Em_',num2str(iE)]).high,...
        sem_conf.perElevel.(['Em_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist/2,...
        avg_conf.perElevel.(['Ep_',num2str(iE)]).low,...
        sem_conf.perElevel.(['Ep_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist*3/2,...
        avg_conf.perElevel.(['Ep_',num2str(iE)]).high,...
        sem_conf.perElevel.(['Ep_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
end
ylim([0 100]);
ylabel('Confidence');
...
bar_hdl.Em = jbfill(1:n_bins,...
    (avg_conf.Em_f_time.low + sem_conf.Em_f_time.low)'.*100,...
    (avg_conf.Em_f_time.low - sem_conf.Em_f_time.low)'.*100,...
    avg_conf.Em_f_time.low'.*100,...
    Em_col_low);
bar_hdl.Em = jbfill(1:n_bins,...
    (avg_conf.Em_f_time.high + sem_conf.Em_f_time.high)'.*100,...
    (avg_conf.Em_f_time.high - sem_conf.Em_f_time.high)'.*100,...
    avg_conf.Em_f_time.high'.*100,...
    Em_col_high);
% physical effort
bar_hdl.Ep = jbfill(1:n_bins,...
    (avg_conf.Ep_f_time.low + sem_conf.Ep_f_time.low)'.*100,...
    (avg_conf.Ep_f_time.low - sem_conf.Ep_f_time.low)'.*100,...
    avg_conf.Ep_f_time.low'.*100,...
    Ep_col_low);
bar_hdl.Ep = jbfill(1:n_bins,...
    (avg_conf.Ep_f_time.high + sem_conf.Ep_f_time.high)'.*100,...
    (avg_conf.Ep_f_time.high - sem_conf.Ep_f_time.high)'.*100,...
    avg_conf.Ep_f_time.high'.*100,...
    Ep_col_high);
ylim([0 100]);
xlim([0 n_bins+1]);
xlabel('trial bins');
...
for iMoney = [-(n_R_levels-1):(-1), 1:(n_R_levels - 1)]
    ...
    bar_hdl.Em_low = bar(iMoney-bDist*3/2,...
        avg_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iMoney-bDist/2,...
        avg_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iMoney+bDist/2,...
        avg_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iMoney+bDist*3/2,...
        avg_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iMoney-bDist*3/2,...
        avg_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        sem_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney-bDist/2,...
        avg_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        sem_RT.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth)
    errorbar(iMoney+bDist/2,...
        avg_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        sem_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth)
    errorbar(iMoney+bDist*3/2,...
        avg_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        sem_RT.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
end
xticks([-3:-(1), 1:3]);
xticklabels({'-3','-2','-1','1','2','3'});
...
hold on;
for iE = 1:(n_E_levels - 1)
    bar_hdl.Em_low = bar(iE-bDist*3/2, avg_RT.perElevel.(['Em_',num2str(iE)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iE-bDist/2, avg_RT.perElevel.(['Em_',num2str(iE)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iE+bDist/2, avg_RT.perElevel.(['Ep_',num2str(iE)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iE+bDist*3/2, avg_RT.perElevel.(['Ep_',num2str(iE)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iE-bDist*3/2,...
        avg_RT.perElevel.(['Em_',num2str(iE)]).low, sem_RT.perElevel.(['Em_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE-bDist/2,...
        avg_RT.perElevel.(['Em_',num2str(iE)]).high, sem_RT.perElevel.(['Em_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist/2,...
        avg_RT.perElevel.(['Ep_',num2str(iE)]).low, sem_RT.perElevel.(['Ep_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist*3/2,...
        avg_RT.perElevel.(['Ep_',num2str(iE)]).high, sem_RT.perElevel.(['Ep_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
end
ylim([0 5]);
ylabel('RT (s)');
...
hold on;
% mental effort
bar_hdl.Em_low = jbfill(1:n_bins,...
    (avg_RT.Em_f_time.low + sem_RT.Em_f_time.low)',...
    (avg_RT.Em_f_time.low - sem_RT.Em_f_time.low)',...
    avg_RT.Em_f_time.low',...
    Em_col_low);
bar_hdl.Em_high = jbfill(1:n_bins,...
    (avg_RT.Em_f_time.high + sem_RT.Em_f_time.high)',...
    (avg_RT.Em_f_time.high - sem_RT.Em_f_time.high)',...
    avg_RT.Em_f_time.high',...
    Em_col_high);
% physical effort
bar_hdl.Ep_low = jbfill(1:n_bins,...
    (avg_RT.Ep_f_time.low + sem_RT.Ep_f_time.low)',...
    (avg_RT.Ep_f_time.low - sem_RT.Ep_f_time.low)',...
    avg_RT.Ep_f_time.low',...
    Ep_col_low);
bar_hdl.Ep_high = jbfill(1:n_bins,...
    (avg_RT.Ep_f_time.high + sem_RT.Ep_f_time.high)',...
    (avg_RT.Ep_f_time.high - sem_RT.Ep_f_time.high)',...
    avg_RT.Ep_f_time.high',...
    Ep_col_high);
ylim([1.5 3]);
xlim([0 n_bins+1]);
xlabel('trial bins');
...
for iAbsMoney = 1:(n_R_levels - 1)
    bar_hdl.Em_low = bar(iAbsMoney-bDist*3/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iAbsMoney-bDist/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iAbsMoney+bDist/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iAbsMoney+bDist*3/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iAbsMoney-bDist*3/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).low,...
        sem_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iAbsMoney-bDist/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).high,...
        sem_Eperformance.perDeltaMoneylevel.(['Em_',num2str(iAbsMoney)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iAbsMoney+bDist/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).low,...
        sem_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iAbsMoney+bDist*3/2,...
        avg_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).high,...
        sem_Eperformance.perDeltaMoneylevel.(['Ep_',num2str(iAbsMoney)]).high,...
        'k','LineWidth',lWidth);
end
ylim([90 100]);
...
for iMoney = [-(n_R_levels-1):(-1), 1:(n_R_levels - 1)]
    ...
    bar_hdl.Em_low = bar(iMoney-bDist*3/2,...
        avg_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iMoney-bDist/2,...
        avg_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iMoney+bDist/2,...
        avg_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iMoney+bDist*3/2,...
        avg_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iMoney-bDist*3/2,...
        avg_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        sem_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney-bDist/2,...
        avg_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        sem_Eperformance.perSignedMoneylevel.(['Em_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist/2,...
        avg_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        sem_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iMoney+bDist*3/2,...
        avg_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        sem_Eperformance.perSignedMoneylevel.(['Ep_',taskCond','_',num2str(jMoney)]).high,...
        'k','LineWidth',lWidth);
end
xticks([-3:-(1), 1:3]);
xticklabels({'-3','-2','-1','1','2','3'});
...
hold on;
for iE = 1:(n_E_levels - 1)
    bar_hdl.Em_low = bar(iE-bDist*3/2, avg_Eperformance.perElevel.(['Em_',num2str(iE)]).low,...
        'FaceColor',Em_col_low,'BarWidth',bWidth/2);
    bar_hdl.Em_high = bar(iE-bDist/2, avg_Eperformance.perElevel.(['Em_',num2str(iE)]).high,...
        'FaceColor',Em_col_high,'BarWidth',bWidth/2);
    bar_hdl.Ep_low = bar(iE+bDist/2, avg_Eperformance.perElevel.(['Ep_',num2str(iE)]).low,...
        'FaceColor',Ep_col_low,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iE+bDist*3/2, avg_Eperformance.perElevel.(['Ep_',num2str(iE)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iE-bDist*3/2,...
        avg_Eperformance.perElevel.(['Em_',num2str(iE)]).low, sem_Eperformance.perElevel.(['Em_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE-bDist/2,...
        avg_Eperformance.perElevel.(['Em_',num2str(iE)]).high, sem_Eperformance.perElevel.(['Em_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist/2,...
        avg_Eperformance.perElevel.(['Ep_',num2str(iE)]).low, sem_Eperformance.perElevel.(['Ep_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist*3/2,...
        avg_Eperformance.perElevel.(['Ep_',num2str(iE)]).high, sem_Eperformance.perElevel.(['Ep_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
end
ylabel('Effort Performance (%)');
xticks(1:3);
...
% mental effort
bar_hdl.Em_low = jbfill(1:n_bins,...
    (avg_Eperformance.Em_f_time.low + sem_Eperformance.Em_f_time.low)',...
    (avg_Eperformance.Em_f_time.low - sem_Eperformance.Em_f_time.low)',...
    avg_Eperformance.Em_f_time.low',...
    Em_col_low);
bar_hdl.Em_high = jbfill(1:n_bins,...
    (avg_Eperformance.Em_f_time.high + sem_Eperformance.Em_f_time.high)',...
    (avg_Eperformance.Em_f_time.high - sem_Eperformance.Em_f_time.high)',...
    avg_Eperformance.Em_f_time.high',...
    Em_col_high);
% physical effort
bar_hdl.Ep_low = jbfill(1:n_bins,...
    (avg_Eperformance.Ep_f_time.low + sem_Eperformance.Ep_f_time.low)',...
    (avg_Eperformance.Ep_f_time.low - sem_Eperformance.Ep_f_time.low)',...
    avg_Eperformance.Ep_f_time.low',...
    Ep_col_low);
bar_hdl.Ep_high = jbfill(1:n_bins,...
    (avg_Eperformance.Ep_f_time.high + sem_Eperformance.Ep_f_time.high)',...
    (avg_Eperformance.Ep_f_time.high - sem_Eperformance.Ep_f_time.high)',...
    avg_Eperformance.Ep_f_time.high',...
    Ep_col_high);
ylim([80 100]);
xlim([0 n_bins+1]);
xlabel('trial bins');
