# script originally written by Riccardo Rota from Nestlé, adapted by N.Clairis to only show the whole-blood NAD metabolism vs general and behavior
# This version will extract correlation coefficients and display all the correlations.
...
# whole-blood metabolites (remove saliva + plasma from circular_plot.R)
# whole-blood
...
circulationList0 = c(bloodList0) # creating the list of variable associated to circulation (= plasma + whole blood + saliva)
circulationList1 = c(bloodList1) # creating the list of variable associated to circulation (= plasma + whole blood + saliva)
...
rThres = 0.40 # Threshold for the absolute value of the correlation coefficient to filter
...
#red colors for circulation variables
bgcol3[] = '#fcae91' # whole-blood NADomics
...
legend(-2.3,1.3,legend = c('whole-blood NAD'),title='Circulation', fill = c('#fcae91'), cex = 1)
