...
[fatigue_measures.MPSTEFS_physical,...
    ...
    fatigue_measures.MPSTEFS_physical_energy,...
    ...
    fatigue_measures.covid_months_since_last_infection,...
    fatigue_measures.F1,...
    fatigue_measures.F2,...
    fatigue_measures.F3,...
    fatigue_measures.F4,...
...
fatigue_measures.covid_months_since_last_infection = questionnaires.general.covid_months_since_last_infection;

%% fatigue-related questionnaires
fatigue_measures.MPSTEFS_physical_energy = questionnaires.Motivation.MPSTEFS_physical_energy;
fatigue_measures.MPSTEFS_mental_energy = questionnaires.Motivation.MPSTEFS_mental_energy;
fatigue_measures.MPSTEFS_physical_fatigue = questionnaires.Motivation.MPSTEFS_physical_fatigue;
fatigue_measures.MPSTEFS_mental_fatigue = questionnaires.Motivation.MPSTEFS_mental_fatigue;
