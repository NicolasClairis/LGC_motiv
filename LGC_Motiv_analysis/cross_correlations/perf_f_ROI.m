...
for iTask = 1:nTasks
    ...
    [ROI_activity.(task_nm).perEch,...
        ...
        perf.(task_nm).forcePeak_N.perEch.(['low_',ROI_short_nm]),...
        ...
        perf.(task_nm).forcePeak_N.perEch.(['high_',ROI_short_nm]),...
        perf.(task_nm).AUC_overshoot.perEch.(['high_',ROI_short_nm]),...
        perf.(task_nm).n_errors.perEch.(['high_',ROI_short_nm]),...
        perf.(task_nm).successSpeed.perEch.(['high_',ROI_short_nm]),...
    ...
    [ROI_activity.(task_nm).choice_highE.perHighElevel,...
        ...
        perf.(task_nm).forcePeak_N.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        ...
        perf.(task_nm).forcePeak_N.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        ...
        perf.(task_nm).forcePeak_N.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        ...
        perf.(task_nm).forcePeak_N.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        ...
        perf.(task_nm).successSpeed.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
