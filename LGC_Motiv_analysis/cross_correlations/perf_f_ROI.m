...
[ROI_activity.allTrials,...
    ...
    r1_cstt.mental, r2_cstt.mental] = deal(NaN(nTrials, NS));
n_hE_levels = 3;
hE_levels = 1:3;
n_Ech = 4;
Ech_levels = 0:3;
for iTask = 1:nTasks
    ...
    [ROI_activity.(task_nm).perEch,...
        ...
        perf.Ep.AUC.perEch.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak.perEch.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.perEch.(['low_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.perEch.(['low_',ROI_short_nm]),...
        perf.Em.n_errors.perEch.(['low_',ROI_short_nm]),...
        perf.Em.successSpeed.perEch.(['low_',ROI_short_nm]),...
        perf.(task_nm).perf.perEch.(['low_',ROI_short_nm]),...
        perf.(task_nm).latency.perEch.(['high_',ROI_short_nm]),...
        perf.Ep.AUC.perEch.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak.perEch.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.perEch.(['high_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.perEch.(['high_',ROI_short_nm]),...
        perf.Em.n_errors.perEch.(['high_',ROI_short_nm]),...
        perf.Em.successSpeed.perEch.(['high_',ROI_short_nm]),...
        perf.(task_nm).perf.perEch.(['high_',ROI_short_nm])] = deal(NaN(n_Ech,NS));
    [ROI_activity.(task_nm).choice_highE.perHighElevel,...
        perf.(task_nm).latency.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.AUC.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Em.n_errors.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Em.successSpeed.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.(task_nm).perf.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.(task_nm).latency.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.AUC.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Em.n_errors.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Em.successSpeed.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.(task_nm).perf.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
        ROI_activity.(task_nm).choice_lowE.perHighElevel,...
        perf.(task_nm).latency.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.AUC.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Em.n_errors.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.Em.successSpeed.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.(task_nm).perf.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
        perf.(task_nm).latency.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.AUC.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.forcePeak_N.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Ep.AUC_overshoot.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Em.n_errors.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.Em.successSpeed.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
        perf.(task_nm).perf.choice_lowE.perHighElevel.(['high_',ROI_short_nm])] = deal(NaN(n_hE_levels,NS));

    % betas for tests
    [betas.Ep.AUC.perEch.bROI,...
        betas.Ep.AUC.perEch.bE,...
        betas.Ep.AUC.perEch.bROI_x_E,...
        betas.Ep.forcePeak.perEch.bROI,...
        betas.Ep.forcePeak.perEch.bE,...
        betas.Ep.forcePeak.perEch.bROI_x_E,...
        betas.Ep.forcePeak_N.perEch.bROI,...
        betas.Ep.forcePeak_N.perEch.bE,...
        betas.Ep.forcePeak_N.perEch.bROI_x_E,...
        betas.Ep.AUC_overshoot.perEch.bROI,...
        betas.Ep.AUC_overshoot.perEch.bE,...
        betas.Ep.AUC_overshoot.perEch.bROI_x_E,...
        betas.Em.n_errors.perEch.bROI,...
        betas.Em.n_errors.perEch.bE,...
        betas.Em.n_errors.perEch.bROI_x_E,...
        betas.Em.successSpeed.perEch.bROI,...
        betas.Em.successSpeed.perEch.bE,...
        betas.Em.successSpeed.perEch.bROI_x_E,...
        betas.(task_nm).perf.perEch.bROI,...
        betas.(task_nm).perf.perEch.bE,...
        betas.(task_nm).perf.perEch.bROI_x_E,...
        betas.(task_nm).latency.perEch.bROI,...
        betas.(task_nm).latency.perEch.bE,...
        betas.(task_nm).latency.perEch.bROI_x_E,] = deal(NaN(1,NS));
end % task loop
...
for iS = 1:NS
    ...
    for iRun = 1:length(okRuns)
        ...
        switch task_nm_tmp
            case 'Ep'
                [latency, AUC, forcePeak, AUC_overshoot, ~, forcePeak_N, ~] = extract_grip_force(subBehaviorFolder, sub_nm, run_nm);
        ...
        for iEch = 1:n_Ech
            ...
            switch task_nm
                case 'physical'
                    ...
                    perf.(task_nm).forcePeak_N.perEch.(['low_',ROI_short_nm])(iEch, iS)   = mean(perf.forcePeak_N.allTrials(low_ROI_Ech,iS),1,'omitnan');
                    % high ROI level
                    ...
                    perf.(task_nm).forcePeak_N.perEch.(['high_',ROI_short_nm])(iEch, iS)   = mean(perf.forcePeak_N.allTrials(high_ROI_Ech,iS),1,'omitnan');
                case 'mental'
                    % low ROI level
            ...
            % low ROI level
            perf.(task_nm).perf.perEch.(['low_',ROI_short_nm])(iEch, iS)        = mean(perf.perf.allTrials(low_ROI_Ech,iS),1,'omitnan');
            % high ROI level
            perf.(task_nm).perf.perEch.(['high_',ROI_short_nm])(iEch, iS)       = mean(perf.perf.allTrials(high_ROI_Ech,iS),1,'omitnan');
        end % effort chosen
        ...
        for iEff = 1:n_hE_levels
            ...
            switch task_nm
                case 'physical'
                    ...
                    perf.(task_nm).forcePeak_N.choice_lowE.perHighElevel.(['low_',ROI_short_nm])(iEff, iS)   = mean(perf.forcePeak_N.allTrials(low_ROI_hE_lowCh,iS),1,'omitnan');
                    ...
                    perf.(task_nm).forcePeak_N.choice_lowE.perHighElevel.(['high_',ROI_short_nm])(iEff, iS)   = mean(perf.forcePeak_N.allTrials(high_ROI_hE_lowCh,iS),1,'omitnan');
                    ...
                    perf.(task_nm).forcePeak_N.choice_highE.perHighElevel.(['low_',ROI_short_nm])(iEff, iS)  = mean(perf.forcePeak_N.allTrials(low_ROI_hE_highCh,iS),1,'omitnan');
                    ...
                    perf.(task_nm).forcePeak_N.choice_highE.perHighElevel.(['high_',ROI_short_nm])(iEff, iS)  = mean(perf.forcePeak_N.allTrials(high_ROI_hE_highCh,iS),1,'omitnan');
                case 'mental'
                    % low ROI - low effort chosen
            ...
            % low ROI - low effort chosen
            perf.(task_nm).perf.choice_lowE.perHighElevel.(['low_',ROI_short_nm])(iEff, iS)         = mean(perf.perf.allTrials(low_ROI_hE_lowCh,iS),1,'omitnan');
            % high ROI - low effort chosen
            perf.(task_nm).perf.choice_lowE.perHighElevel.(['high_',ROI_short_nm])(iEff, iS)        = mean(perf.perf.allTrials(high_ROI_hE_lowCh,iS),1,'omitnan');
            % low ROI - high effort chosen
            perf.(task_nm).perf.choice_highE.perHighElevel.(['low_',ROI_short_nm])(iEff, iS)        = mean(perf.perf.allTrials(low_ROI_hE_highCh,iS),1,'omitnan');
            % high ROI - high effort chosen
            perf.(task_nm).perf.choice_highE.perHighElevel.(['high_',ROI_short_nm])(iEff, iS)       = mean(perf.perf.allTrials(high_ROI_hE_highCh,iS),1,'omitnan');
        end % effort level
        
        %% statistical test and fit eventually
        % Ep: AUC
        Ep_trials = task_cstt.physical(:,iS) == 1;
        r1_Ep_cstt = r1_cstt.physical(Ep_trials, iS);
        r2_Ep_cstt = r2_cstt.physical(Ep_trials, iS);
        E_chosen_Ep = E_chosen(Ep_trials,iS);
        ROI_Ep = ROI_activity.allTrials(Ep_trials,iS);
        ROI_x_Ech_Ep = ROI_Ep.*E_chosen_Ep;
        x_Ep = [E_chosen_Ep, ROI_Ep, ROI_x_Ech_Ep];
        x_reg_Ep_names = {'bE','bROI','bROI_x_E'};
        [betas_Ep_AUC_tmp, AUC_fit(:,iS)] = glmfit_adapted_for_runConstants(r1_Ep_cstt, r2_Ep_cstt,...
            x_Ep, perf.AUC.allTrials(Ep_trials,iS), x_reg_Ep_names);
        for iR = 1:length(x_reg_Ep_names)
            b_nm = x_reg_Ep_names{iR};
            betas.Ep.AUC.perEch.(b_nm)(iS) = betas_Ep_AUC_tmp.(b_nm);
        end
...
for iROI_lvl = 1:length(ROI_level)
    ...
    [m_perf.physical.forcePeak_N.perEch.(ROI_info_nm),...
        sem_perf.physical.forcePeak_N.perEch.(ROI_info_nm)] = mean_sem_sd(perf.physical.forcePeak_N.perEch.(ROI_info_nm), 2);
    [m_perf.physical.perf.perEch.(ROI_info_nm),...
        sem_perf.physical.perf.perEch.(ROI_info_nm)] = mean_sem_sd(perf.physical.perf.perEch.(ROI_info_nm), 2);
    % mental
    ...
    [m_perf.mental.perf.perEch.(ROI_info_nm),...
        sem_perf.mental.perf.perEch.(ROI_info_nm)] = mean_sem_sd(perf.mental.perf.perEch.(ROI_info_nm), 2);
    ...
    [m_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(ROI_info_nm),...
        sem_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.physical.forcePeak_N.choice_lowE.perHighElevel.(ROI_info_nm), 2);
    [m_perf.physical.perf.choice_lowE.perHighElevel.(ROI_info_nm),...
        sem_perf.physical.perf.choice_lowE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.physical.perf.choice_lowE.perHighElevel.(ROI_info_nm), 2);
    % mental
    ...
    [m_perf.mental.perf.choice_lowE.perHighElevel.(ROI_info_nm),...
        sem_perf.mental.perf.choice_lowE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.mental.perf.choice_lowE.perHighElevel.(ROI_info_nm), 2);
    ...
    [m_perf.physical.forcePeak_N.choice_highE.perHighElevel.(ROI_info_nm),...
        sem_perf.physical.forcePeak_N.choice_highE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.physical.forcePeak_N.choice_highE.perHighElevel.(ROI_info_nm), 2);
    [m_perf.physical.perf.choice_highE.perHighElevel.(ROI_info_nm),...
        sem_perf.physical.perf.choice_highE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.physical.perf.choice_highE.perHighElevel.(ROI_info_nm), 2);
    % mental
    ...
    [m_perf.mental.perf.choice_highE.perHighElevel.(ROI_info_nm),...
        sem_perf.mental.perf.choice_highE.perHighElevel.(ROI_info_nm)] = mean_sem_sd(perf.mental.perf.choice_highE.perHighElevel.(ROI_info_nm), 2);
...
subplot(2,3,3);
hold on;
Ech_Fpeak_N_low_ROI_hdl = errorbar(Ech_levels,...
    m_perf.physical.forcePeak_N.perEch.(['low_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.perEch.(['low_',ROI_short_nm]));
Ech_Fpeak_N_high_ROI_hdl = errorbar(Ech_levels,...
    m_perf.physical.forcePeak_N.perEch.(['high_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.perEch.(['high_',ROI_short_nm]));
% modify curve properties
Ech_Fpeak_N_low_ROI_hdl.LineStyle = '--';
Ech_Fpeak_N_low_ROI_hdl.LineWidth = lWidth;
Ech_Fpeak_N_low_ROI_hdl.Color = blue;
Ech_Fpeak_N_high_ROI_hdl.LineStyle = '-';
Ech_Fpeak_N_high_ROI_hdl.LineWidth = lWidth;
Ech_Fpeak_N_high_ROI_hdl.Color = purple;
legend([Ech_Fpeak_N_high_ROI_hdl, Ech_Fpeak_N_low_ROI_hdl],...
    {['high ',ROI_short_nm],['low ',ROI_short_nm]});
legend('boxoff');
legend('Location','NorthWest');
xticks(Ech_levels);
...
subplot(2,3,3);
hold on;
hE_lowEchoice_Fpeak_N_lowROI_hdl = errorbar(hE_levels,...
    m_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(['low_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(['low_',ROI_short_nm]));
hE_lowEchoice_Fpeak_N_highROI_hdl = errorbar(hE_levels,...
    m_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(['high_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.choice_lowE.perHighElevel.(['high_',ROI_short_nm]));
hE_highEchoice_Fpeak_N_lowROI_hdl = errorbar(hE_levels,...
    m_perf.physical.forcePeak_N.choice_highE.perHighElevel.(['low_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.choice_highE.perHighElevel.(['low_',ROI_short_nm]));
hE_highEchoice_Fpeak_N_highROI_hdl = errorbar(hE_levels,...
    m_perf.physical.forcePeak_N.choice_highE.perHighElevel.(['high_',ROI_short_nm]),...
    sem_perf.physical.forcePeak_N.choice_highE.perHighElevel.(['high_',ROI_short_nm]));
% modify curve properties
hE_lowEchoice_Fpeak_N_lowROI_hdl.LineStyle = '--';
hE_lowEchoice_Fpeak_N_lowROI_hdl.LineWidth = lWidth;
hE_lowEchoice_Fpeak_N_lowROI_hdl.Color = blue;
hE_lowEchoice_Fpeak_N_highROI_hdl.LineStyle = '--';
hE_lowEchoice_Fpeak_N_highROI_hdl.LineWidth = lWidth;
hE_lowEchoice_Fpeak_N_highROI_hdl.Color = purple;
hE_highEchoice_Fpeak_N_lowROI_hdl.LineStyle = '-';
hE_highEchoice_Fpeak_N_lowROI_hdl.LineWidth = lWidth;
hE_highEchoice_Fpeak_N_lowROI_hdl.Color = blue;
hE_highEchoice_Fpeak_N_highROI_hdl.LineStyle = '-';
hE_highEchoice_Fpeak_N_highROI_hdl.LineWidth = lWidth;
hE_highEchoice_Fpeak_N_highROI_hdl.Color = purple;
legend([hE_highEchoice_Fpeak_N_highROI_hdl,...
    hE_highEchoice_Fpeak_N_lowROI_hdl,...
    hE_lowEchoice_Fpeak_N_highROI_hdl,...
    hE_lowEchoice_Fpeak_N_lowROI_hdl],...
    {['hEch - high ',ROI_short_nm],...
    ['hEch - low ',ROI_short_nm],...
    ['lowEch - high ',ROI_short_nm],...
    ['lowEch - low ',ROI_short_nm]});
