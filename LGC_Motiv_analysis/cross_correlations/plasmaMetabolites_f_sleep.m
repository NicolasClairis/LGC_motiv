function[betas, pval, r_corr] = plasmaMetabolites_f_sleep(fig_disp, rmv_outliers_yn)
% [betas, pval, r_corr] = plasmaMetabolites_f_sleep(fig_disp, rmv_outliers_yn)
...
if fig_disp == 1
    ...
    plot(hours(minutes(avgSleep(goodSubjects_avgS))),...
        metabolite_fit_avgSleep.*yScaling,...
