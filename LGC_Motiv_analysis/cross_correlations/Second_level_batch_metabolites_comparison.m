...
switch condition
    ...
    case 'fMRI_noSatRun_choiceSplit_Elvl'
        results_folder = [mainPath,...
            'GLM',GLM_str,'_',NS_str,'subs_',...
            'preprocSm',num2str(preproc_sm_kernel),'mm_noSatRun_Elvl_',MRS_split_nm,filesep];
    case 'fMRI_noSatRun_choiceSplit_Elvl_bis'
        results_folder = [mainPath,...
            'GLM',GLM_str,'_',NS_str,'subs_',...
            'preprocSm',num2str(preproc_sm_kernel),'mm_noSatRun_Elvl_bis_',MRS_split_nm,filesep];
