...
for iGrp = 1:n_met_grps
    ...
    [m_RT_f_input_mbSplit.(grp_nm_bis),...
        sem_RT_f_input_mbSplit.(grp_nm_bis)] = mean_sem_sd(RT_f_input_bin(:,met_subs.(grp_nm)), 2);
    ...
    [m_RT_f_input_low_ROI_mbSplit.(grp_nm_bis),...
        sem_RT_f_input_low_ROI_mbSplit.(grp_nm_bis)] = mean_sem_sd(RT_f_input_low_ROI(:,met_subs.(grp_nm)), 2);
    ...
    [m_RT_f_input_high_ROI_mbSplit.(grp_nm_bis),...
        sem_RT_f_input_high_ROI_mbSplit.(grp_nm_bis)] = mean_sem_sd(RT_f_input_high_ROI(:,met_subs.(grp_nm)), 2);
...
if dispFig == true
    ...
    gal_data_hdl_low_met = errorbar(m_input_f_input_mbSplit.(low_met_nm),...
        m_RT_f_input_mbSplit.(low_met_nm),...
        sem_RT_f_input_mbSplit.(low_met_nm));
    gal_data_hdl_high_met = errorbar(m_input_f_input_mbSplit.(high_met_nm),...
        m_RT_f_input_mbSplit.(high_met_nm),...
        sem_RT_f_input_mbSplit.(high_met_nm));
    ...
    fig;
    hold on;
    RT_f_inputs_low_ROI_data_low_met_hdl = errorbar(m_input_f_input_low_ROI_mbSplit.(low_met_nm),...
        m_RT_f_input_low_ROI_mbSplit.(low_met_nm),...
        sem_RT_f_input_low_ROI_mbSplit.(low_met_nm));
    RT_f_inputs_high_ROI_data_low_met_hdl = errorbar(m_input_f_input_high_ROI_mbSplit.(low_met_nm),...
        m_RT_f_input_high_ROI_mbSplit.(low_met_nm),...
        sem_RT_f_input_high_ROI_mbSplit.(low_met_nm));
    RT_f_inputs_low_ROI_data_high_met_hdl = errorbar(m_input_f_input_low_ROI_mbSplit.(high_met_nm),...
        m_RT_f_input_low_ROI_mbSplit.(high_met_nm),...
        sem_RT_f_input_low_ROI_mbSplit.(high_met_nm));
    RT_f_inputs_high_ROI_data_high_met_hdl = errorbar(m_input_f_input_high_ROI_mbSplit.(high_met_nm),...
        m_RT_f_input_high_ROI_mbSplit.(high_met_nm),...
        sem_RT_f_input_high_ROI_mbSplit.(high_met_nm));
