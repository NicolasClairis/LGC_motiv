...
[successSpeed.allTrials,...
    ...
    efficacy_bis_pureNback.allTrials] = deal(NaN(1,nTrialsPerRun));
[successSpeed.per_Ech,...
    ...
    efficacy_bis_pureNback.per_Ech] = deal(NaN(1,n_Ech));
[successSpeed.per_hE.choice_lowE,...
    ...
    efficacy_bis_pureNback.per_hE.choice_highE] = deal(NaN(1,n_hE_levels));
%% load the data
