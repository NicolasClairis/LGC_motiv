...
for iE = 1:(n_E_levels - 1)
    bar_hdl.Em_low = bar(iE-bDist*3/2, avg_RT.perElevel.(['Em_',num2str(iE)]).low,...
        'FaceColor',Em_col,'BarWidth',bWidth/2);
    ...
    bar_hdl.Ep_low = bar(iE+bDist/2, avg_RT.perElevel.(['Ep_',num2str(iE)]).low,...
        'FaceColor',Ep_col,'BarWidth',bWidth/2);
    bar_hdl.Ep_high = bar(iE+bDist*3/2, avg_RT.perElevel.(['Ep_',num2str(iE)]).high,...
        'FaceColor',Ep_col,'BarWidth',bWidth/2);
    errorbar(iE-bDist*3/2,...
        avg_RT.perElevel.(['Em_',num2str(iE)]), sem_RT.perElevel.(['Em_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE-bDist/2,...
        avg_RT.perElevel.(['Em_',num2str(iE)]), sem_RT.perElevel.(['Em_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist/2,...
        avg_RT.perElevel.(['Ep_',num2str(iE)]), sem_RT.perElevel.(['Ep_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist*3/2,...
        avg_RT.perElevel.(['Ep_',num2str(iE)]), sem_RT.perElevel.(['Ep_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
end
ylim([0 5]);
ylabel('RT (s)');
...
for iE = 1:(n_E_levels - 1)
    ...
    bar_hdl.Ep_high = bar(iE+bDist*3/2, avg_Eperformance.perElevel.(['Ep_',num2str(iE)]).high,...
        'FaceColor',Ep_col_high,'BarWidth',bWidth/2);
    errorbar(iE-bDist*3/2,...
        avg_Eperformance.perElevel.(['Em_',num2str(iE)]), sem_Eperformance.perElevel.(['Em_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE-bDist/2,...
        avg_Eperformance.perElevel.(['Em_',num2str(iE)]), sem_Eperformance.perElevel.(['Em_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist/2,...
        avg_Eperformance.perElevel.(['Ep_',num2str(iE)]), sem_Eperformance.perElevel.(['Ep_',num2str(iE)]).low,...
        'k','LineWidth',lWidth);
    errorbar(iE+bDist*3/2,...
        avg_Eperformance.perElevel.(['Ep_',num2str(iE)]), sem_Eperformance.perElevel.(['Ep_',num2str(iE)]).high,...
        'k','LineWidth',lWidth);
end
ylabel('Effort Performance (%)');
xticks(1:3);
