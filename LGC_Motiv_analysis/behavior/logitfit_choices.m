...
for iPM = 1:2
    ...
    % model 1
    [choiceNonDef.perNVLevel.Mdl1.(task_id),...
        deltaNV_bins.Mdl1.(task_id)] = do_bin2(choice_nonDef.(task_id), deltaNV.mdl1.(task_id), n_NV_bins, 0);
    [choiceFitNonDef.perNVLevel.Mdl1.(task_id),...
        deltaNV_bins.Mdl1.(task_id)] = do_bin2(fitMdl1.(task_id), deltaNV.mdl1.(task_id), n_NV_bins, 0);
    % model 2
    [choiceNonDef.perNVLevel.Mdl2.(task_id),...
        deltaNV_bins.Mdl2.(task_id)] = do_bin2(choice_nonDef.(task_id), deltaNV.mdl2.(task_id), n_NV_bins, 0);
    [choiceFitNonDef.perNVLevel.Mdl2.(task_id),...
        deltaNV_bins.Mdl2.(task_id)] = do_bin2(fitMdl2.(task_id), deltaNV.mdl2.(task_id), n_NV_bins, 0);
    % model 3
    [choiceNonDef.perNVLevel.Mdl3.(task_id),...
        deltaNV_bins.Mdl3.(task_id)] = do_bin2(choice_nonDef.(task_id), deltaNV.mdl3.(task_id), n_NV_bins, 0);
    [choiceFitNonDef.perNVLevel.Mdl3.(task_id),...
        deltaNV_bins.Mdl3.(task_id)] = do_bin2(fitMdl3.(task_id), deltaNV.mdl3.(task_id), n_NV_bins, 0);
    % model 4
    [choiceNonDef.perNVLevel.Mdl4.(task_id),...
        deltaNV_bins.Mdl4.(task_id)] = do_bin2(choice_nonDef.(task_id), deltaNV.mdl4.(task_id), n_NV_bins, 0);
    [choiceFitNonDef.perNVLevel.Mdl4.(task_id),...
        deltaNV_bins.Mdl4.(task_id)] = do_bin2(fitMdl4.(task_id), deltaNV.mdl4.(task_id), n_NV_bins, 0);
