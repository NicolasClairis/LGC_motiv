function [var,all_choices,all_choices_rescaled,deltaRP_idx,deltaRP,deltaE,RT_physical,RT_mental,all_MVC,all_NMP,physical_IP,mental_IP,perf,...
    Incentive_idx] = reshape_data(i_sub,all_data,rescale_choice,binary_answers,p_or_m)
...
m_ratio1 = [0 m_ratio1(2:end)];
m_ratio2 = [0 m_ratio2(2:end)];
p_force1 = [0 p_force1(2:end)];
p_force2 = [0 p_force2(2:end)];
p_AUC1 = [0 p_AUC1(2:end)]/100;
p_AUC2 = [0 p_AUC2(2:end)]/100;
