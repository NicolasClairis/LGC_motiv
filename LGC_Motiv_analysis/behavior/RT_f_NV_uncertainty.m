function[RT_f_pChoice_bin, pChoice_f_pChoice_bin, mediation_paths, pval,...
    ...
    path_c_lowConfMdl_confRtg, path_cprime_lowConfMdl_confRtg] = RT_f_NV_uncertainty(study_nm, subject_id, condition, figDisp)
% [RT_f_pChoice_bin, pChoice_f_pChoice_bin, mediation_paths, pval,...
%     RT_orth_ConfMdl_f_pChoice_bin, RT_orth_ConfMdl_f_RT_orth_ConfMdl_bin,...
%     conf_rtg_f_RT_orth_ConfMdl_bin,...
%     path_a_confMdl_RT, path_b_RT_confRtg,...
%     path_c_confMdl_confRtg, path_cprime_confMdl_confRtg,...
