...
for iS = 1:NS
    ...
    for iPM = 1:2
        ...
        % extract betas
        % model 1
        betas.(task_id).mdl_1.kb0(iS) = betas_tmp.(task_id).mdl_1.kb0;
        ...
        % model 2
        betas.(task_id).mdl_2.kb0(iS) = betas_tmp.(task_id).mdl_2.kb0;
        ...
        % model 3
        betas.(task_id).mdl_3.kb0(iS) = betas_tmp.(task_id).mdl_3.kb0;
        ...
        % model 4
        betas.(task_id).mdl_4.kb0(iS) = betas_tmp.(task_id).mdl_4.kb0;
