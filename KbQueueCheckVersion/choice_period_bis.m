function[choice_trial, onsetDispChoiceOptions, onsetChoice, stoptask] = choice_period_bis(scr, stim,...
    R_left, R_right, E_left, E_right, R_or_P,...
    timeParameter, key, confidenceDisp)
% [choice_trial, onsetDispChoiceOptions, onsetChoice, stoptask] = choice_period_bis(scr, stim,...
%     R_left, R_right, E_left, E_right, R_or_P,...
%     timeParameter, key, confidenceDisp)
...
%
% Same as choice_period but replacing KbCheck by KbQueueCheck
%
% INPUTS
