        ...
        case 'p'
            ...
            if strcmp(taskToPerform.physical.training,'on')
                ...
                for iTrainingCondition = 1:n_trainingConfConditions
                    ...
                    % perform the training
                    [trainingSummary_Ep.(['session',num2str(iTrainingCondition),'_',trainingConfCond])] = choice_and_perf_bis(scr, stim, key_Ep, 'physical', Ep_vars_training,...
        ...
        case 'm'
            ...
            if strcmp(taskToPerform.mental.training,'on')
                ...
                for iTrainingCondition = 1:n_trainingConfConditions
                    ...
                    % select effort level
                    [trainingSummary_Em.(trainingConfCond)] = choice_and_perf_bis(scr, stim, key_Em, 'mental', Em_vars_training,...
                ...
                switch p_or_m
                    ...
                    case 'm'
                        if strcmp(taskToPerform.mental.task,'on')
                            ...
                            perf_Em_IP_tmp = choice_and_perf_staircase_bis(scr, stim, key_Em,...
                                'mental', Em_vars,...
