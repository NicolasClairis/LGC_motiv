function[summary] = choice_and_perf_bis(scr, stim, key,...
    effort_type, Ep_or_Em_vars,...
    training_R_P_RP_or_mainTask, nTrials, choiceOptions, confidenceDispChoice,...
    timings,...
    results_folder, file_nm)
% [summary] = choice_and_perf_bis(scr, stim, key,...
%     effort_type, Ep_or_Em_vars,...
%     R_or_P_or_RP_condition, nTrials, choiceOptions, confidenceDispChoice,...
%     timings,...
%     results_folder, file_nm)
% choice_and_perf_bis: script to perform choice and effort performance.
% Same as choice_and_perf but replacing all functions using KbCheck by
% equivalent functions using KbQueueCheck
%
% INPUTS
