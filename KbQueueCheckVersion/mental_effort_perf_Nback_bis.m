function[mentalE_perf, trial_success, onsets] = mental_effort_perf_Nback_bis(scr, stim, key,...
...
%[mentalE_perf, trial_success, onsets] = mental_effort_perf_Nback_bis(scr, stim, key,...
%     numberVector, mentalE_prm, n_max_to_reach,...
...
%
% This script is similar to mental_effort_perf_Nback but all calls to
% KbCheck have been replaced by calls to KbQueueCheck
%
% INPUTS
