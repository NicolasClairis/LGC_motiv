function [pars,se,ci,mn,id,gof,res]=sem_fit(model_specs,data) 
...
% value by entering that value in the corresponding matrix element. a fixed value of 0 means 
% no relationship between those two variables. The model_specs.obs and model_specs.lat fields simply specify 
...
% asymmetric. next outputs are vector containing standard errors, matrix
% containing confidence intervals, flags for multivariate normality
...
% ,including p-value for chi-sq. (gof(1,2)) and 90% CIs for RMSEA (gof(1,2) and
% gof(1,3)) and matrix of residuals.
