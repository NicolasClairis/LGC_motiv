function[] = img2nii_spm()
%%img2nii.m--------------------------------------------
%function to convert hdr/img files to nii.
%This script uses SPM function, so you need to install SPM5 or later.
% The default is that the output is in the same folder as the input with
% the same name but converted into one single .nii file.
%
