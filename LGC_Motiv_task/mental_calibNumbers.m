...
DrawFormattedText(window,...
    ['Desormais vous devrez repondre dans un temps limite. Essayez de completer',...
    ' le cercle en repondant aussi vite que possible et correctement aux questions posees.',...
    ' Comme precedemment, une reponse incorrecte reinitialisera le compteur.'],...
...
DrawFormattedText(window,...
    ...
    'center', yScreenCenter/3, selectedCol, wrapat);
DrawFormattedText(window,...
    'Vous pouvez appuyer quand vous vous sentez pret(e) a commencer.',...
...
for iCalibTrial = 1:n_calibTrials
    ...
    if iCalibTrial < n_calibTrials
        DrawFormattedText(window,...
            'Vous pouvez appuyer quand vous vous sentez pret(e) a recommencer.',...
            'center', yScreenCenter*(5/3), selectedCol, wrapat);
