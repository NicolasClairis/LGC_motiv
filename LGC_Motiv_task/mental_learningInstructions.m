    ...
    switch learning_instructions
        case 'fullInstructions' % WITH INSTRUCTIONS
            DrawFormattedText(window,...
                ['Vous allez pouvoir vous entrainer a effectuer la tache. ',...
        ...
        case 'partialInstructions'
            DrawFormattedText(window,...
                ['Vous allez pouvoir vous entrainer a effectuer la tache mais vous ',...
        ...
        case 'extendedLearning'
            DrawFormattedText(window,...
                ['Attention, desormais, vous allez devoir repondre au chiffre ',...
