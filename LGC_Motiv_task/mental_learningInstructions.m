...
for iTimeLoop = 1:2
    switch learning_instructions
        ...
        case 'extendedLearning'
            DrawFormattedText(window,...
                ['Attention, désormais, vous allez devoir répondre au chiffre ',...
                'qui vient d''être affiché, pas au chiffre qui est à l''écran. ',...
                ' Appuyez sur n''importe quel bouton pour le premier chiffre. ',...
                'Vous ne pourrez jamais répondre au dernier chiffre affiché. ',...
                'Pour rappel:'],...
                'center',yScreenCenter/3,selectedCol, wrapat);
    end
