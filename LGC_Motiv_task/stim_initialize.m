...
%             'question a laquelle il faut repondre. Pour rappel:'];
        stim.Em.learning.partialInstructions.text = ['Vous allez pouvoir vous entrainer a nouveau, mais vous ',...
...
stim.Em.learning.partialInstructions.text = ['You can train to perform the task again but you ',...
...
switch langage
    case 'fr'
        ...
        stim.Em.learning.learning_Nback2_bis.text = ['Il faut toujours repondre avec un decalage de 2. ',...
            'Attention desormais il faudra aussi aller le plus vite possible. Le trait rouge indique le minimum a atteindre a chaque essai. ',...
            'Le trait orange indiquera votre maximum.'];
    case 'engl'
        ...
        stim.Em.learning.learning_Nback2_bis.text = ['You still have to answer with a delay of 2. ',...
            'Be careful now you also have to be as fast as possible. The red line indicates the minimum to reach on every trial. ',...
            'The orange line indicates your maximum until now.'];
end
