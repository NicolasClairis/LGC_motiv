function [choice_design] = choice_design_RE_levels_4levels(n_RP_levels, n_E_levels, n_trials, RP_condition)
%[choice_design] = choice_design_RE_levels_4levels(n_RP_levels, n_E_levels, n_trials, RP_condition)
