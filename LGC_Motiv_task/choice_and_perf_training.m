function[trainingSummary] = choice_and_perf_training(scr, stim, key,...
    effort_type, Ep_or_Em_vars, R_money,...
    R_or_P_or_RP_condition, R_or_P_trials, nTrials, choiceOptions, timings)
% [trainingSummary] = choice_and_perf_training(scr, stim, key,...
%     effort_type, Ep_or_Em_vars, R_money,...
%     R_or_P_or_RP_condition, R_or_P_trials, nTrials, choiceOptions, timings)
% choice_and_perf_training: script to perform choice and effort
