function[t_min_reached_duringCalib, calib_summary, calib_success] = LGCM_mental_calibTime(scr, stim, key,...
    numberVector_calib, mentalE_prm, n_calibTrials, n_calibMax, calibTimes)
%[t_min_reached_duringCalib, calib_summary, calib_success] = LGCM_mental_calibTime(scr, stim, key,...
%     numberVector_calib, mentalE_prm, n_calibTrials, n_calibMax, calibTimes)
%
% LGCM_mental_calibTime will extract the maximal amount of time requested
